...
function wingen(winBackbone, configuration)
{
    ...
    function qCallAwareCreateArtifacts()
    {
        ...
        [].push.call(arguments, function(err, offspring)
        {
            if(err)
                ...
                defer.resolve({call: callAware, offspring: offspring});
        })
    ...
    {   
        ...
        return {promises: promises, children: children};
    }
    ...
    self.qCreateChildReferences = function(type, schemaProps, genProps, parentProps, overrideJSON)
    {
        var count = genProps.count;
        ...
        .then(function(refBehavior)
        {
            ...
            for(var rp in refPaths)
            {
                ...
                if(action.children)
                    pathToChildren[rp] = action.children;
    ...
    self.qCreateChildren = function(type, schemaProps, genProps, parentProps, overrideJSON)
    {
        ...
        .then(function(childrenAndIxs)
        {
            ...
            if(refCount)
                return self.qCreateChildReferences(type, schemaProps, genProps, parentProps, overrideJSON);
            else
                return;
        })
        .then(function()
